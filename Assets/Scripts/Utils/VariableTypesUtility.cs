...
public class VariableTypesUtility 
{
    ...
    public static void UpdateAllVariables(VisualElement element, CustomEnumFlags<VariableType> variablesContainer)
    {
        ...
        {
            if (variablesContainer.ContainsValue(variable))
            {
